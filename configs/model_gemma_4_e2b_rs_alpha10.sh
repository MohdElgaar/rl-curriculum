...
export ATTN_IMPLEMENTATION="torch"
...
export EXP_NAME="${MODEL_BASENAME}_${DATASET_BASENAME}_${LEARNING_RATE}_a${IFEVAL_COMPETENCE_ALPHA}_n${IFEVAL_NUM_CURRICULUM_STEPS}_s${SEED}"  # separate OUTPUT_DIR per seed