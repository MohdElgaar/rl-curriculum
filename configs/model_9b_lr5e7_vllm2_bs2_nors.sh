#!/bin/bash
#
# Qwen3.5-9B: no IFEval reward shaping (baseline for comparison).
...
#   sbatch scripts/slurm/if_rlvr.sbatch configs/data_unity.sh configs/gpus_8.sh configs/model_9b_lr5e7_vllm2_bs2_nors.sh
...
export EXP_NAME="${MODEL_BASENAME}_${DATASET_BASENAME}_${LEARNING_RATE}_vllm${VLLM_NUM_ENGINES}_bs${PER_DEVICE_BATCH_SIZE}_nors_seed${SEED}"
