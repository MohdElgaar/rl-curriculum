#!/bin/bash
#
# Qwen3-0.6B: reward shaping + competence curriculum with IFEVAL_COMPETENCE_ALPHA=0.1
#
# Usage (Unity paths + 8-GPU layout come first; do not duplicate them here):
#   sbatch scripts/slurm/if_rlvr.sbatch configs/data_unity.sh configs/gpus_8.sh configs/model_0.6b_lr1e6_rs_curriculum_alpha0p1_seed3.sh
