...
#
# Usage:
#   source configs/model_1.7b_lr1e6_rs_alpha10_n400.sh
#   source configs/gpus_4.sh
#
# Same as model_1.7b_lr1e6_rs_alpha10.sh with IFEVAL_NUM_CURRICULUM_STEPS=400.
...
export IFEVAL_NUM_CURRICULUM_STEPS=400
