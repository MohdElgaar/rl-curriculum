#!/bin/bash
#
# Qwen3.5-9B: reward shaping + competence curriculum (IFEVAL_COMPETENCE_ALPHA=10).
...
#   sbatch scripts/slurm/if_rlvr.sbatch configs/data_unity.sh configs/gpus_8.sh configs/model_9b_lr5e7_vllm2_bs2_rs_curriculum_a10.sh
...
export EXP_NAME="${MODEL_BASENAME}_${DATASET_BASENAME}_alpha${IFEVAL_COMPETENCE_ALPHA}_n${IFEVAL_NUM_CURRICULUM_STEPS}_seed${SEED}"
