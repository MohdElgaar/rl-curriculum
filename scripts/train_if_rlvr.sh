...
echo "MATH reward shaping: ${MATH_REWARD_SHAPING} (curriculum=${MATH_REWARD_SHAPING_CURRICULUM}, random_zero=${MATH_RANDOM_ZERO_REWARD})"
echo "GSM reward shaping: ${GSM_REWARD_SHAPING} (curriculum=${GSM_REWARD_SHAPING_CURRICULUM}, random_zero=${GSM_RANDOM_ZERO_REWARD})"
