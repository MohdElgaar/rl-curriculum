...
def build_train_command(spec: RunSpec, run_dir: pathlib.Path, project_root: pathlib.Path) -> list[str]:
    ...
    cmd.extend(
        [
            ...
            "--ifeval_random_zero_reward",
            env("IFEVAL_RANDOM_ZERO_REWARD", "False") or "False",
            ...
            "--math_random_zero_reward",
            env("MATH_RANDOM_ZERO_REWARD", "False") or "False",
            "--math_competence_c0",
            ...
            "--gsm_random_zero_reward",
            env("GSM_RANDOM_ZERO_REWARD", "False") or "False",
            "--gsm_competence_c0",
